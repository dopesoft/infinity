// honesty-machinery: do-not-revert — connector-coverage checklist that raises a
// finding when the backend errors (0 accounts ≠ nothing to cover). See the
// CLAUDE.md self-healing hard rule + memory project_sentry_blind_revert.
