...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => (
    <textarea
      ref={ref}
      className={cn(
        // Compact desktop default (text-sm + min-h-9). The Composer auto-resize
        // path overrides min-height inline. PromptInputBox uses its own textarea
        // primitive so its bigger 16px size is unaffected.
