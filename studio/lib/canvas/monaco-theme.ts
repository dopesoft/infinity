...
export function registerInfinityThemes(monaco: typeof Monaco) {
  monaco.editor.defineTheme(INFINITY_DARK, {
    ...
    colors: {
      ...
      "diffEditor.insertedTextBackground": "#22c55e66",
      "diffEditor.removedTextBackground": "#ef444466",
      "diffEditor.insertedLineBackground": "#22c55e33",
      "diffEditor.removedLineBackground": "#ef444433",
      "diffEditorGutter.insertedLineBackground": "#22c55e80",
      "diffEditorGutter.removedLineBackground": "#ef444480",
  ...
  monaco.editor.defineTheme(INFINITY_LIGHT, {
    ...
    colors: {
      ...
      "diffEditor.insertedTextBackground": "#16a34a55",
      "diffEditor.removedTextBackground": "#dc262655",
      "diffEditor.insertedLineBackground": "#22c55e2e",
      "diffEditor.removedLineBackground": "#ef44442e",
      "diffEditorGutter.insertedLineBackground": "#16a34a99",
      "diffEditorGutter.removedLineBackground": "#dc262699",
    },
  });
}
