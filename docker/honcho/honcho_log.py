# honcho_log.py — log-routing helper baked into the honcho image.
#
...
# stderr, so uvicorn/app INFO lines surface in Railway as fake red errors.
# The log_config.json baked next to this module routes records by level:
# anything below ERROR goes to stdout, ERROR+ goes to stderr. This filter
# is what lets the stdout handler reject genuine errors so they fall
